...
# ======================================================
# TABLE: edit + delete  (ČIA VIENINTELIS PATAISYMAS: scroll dėžutė)
# ======================================================
st.subheader("📋 Įrašai (redagavimas / trynimas)")

# Tik UI: apribojam aukštį ir įjungiam vidinį scroll
st.markdown("""
<style>
.records-scrollbox {
    max-height: 420px;      /* ~10 įrašų (uždaryti expanderiai). Jei reikia – koreguok 360-520 */
    overflow-y: auto;
    padding-right: 10px;
